class Api::V1::MpWebhookController < ActionController::API
  require_dependency Rails.root.join('app/infrastructure/external_apis/mercadopago/mercadopago_webhook_adapter.rb')
  require 'digest'
  ...
  def payment_notification
    ...
    process_notification_service = ProcessMercadopagoNotification.new(
      mercadopago_webhook_adapter: ::MercadoPago::WebhookAdapter.new,
